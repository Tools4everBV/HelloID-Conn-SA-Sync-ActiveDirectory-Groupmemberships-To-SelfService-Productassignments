...
| $adUserCorrelationProperty    | String value of name of the property of AD users to match to HelloID users    | The default value ("SID") is set to match the value from the [ActiveDirectory Groups to Products Sync](https://docs.helloid.com/en/access-management/directory-sync/active-directory-sync.html), where the AD user SID is set to the HelloID User immutableId. If your users are from a different source, change this accordingly (e.g. userPrincipalName)  |
| $helloIDUserCorrelationProperty   | String value of name of the property of HelloID users to match to AD users    | The default value ("immutableId") is set to match the value from the [ActiveDirectory Groups to Products Sync](https://docs.helloid.com/en/access-management/directory-sync/active-directory-sync.html), where the AD user SID is set to the HelloID User immutableId. If your users are from a different source, change this accordingly (e.g. username)   |
